...
class GymRunner(Runner):
    def __init__(self, args=None, local_rank=0):
        ...
        self.replay_buffer = make_buffer(args, discrete=False, use_threads=args.use_threads, type="onpolicy")
        self.wsenv = args.env
        self.config = args
...
if __name__ == '__main__':
    ...
    parser.add_argument("--use_threads", type=bool, default=False, help="env use threads or not")
    ...
    setattr(args, 'n_rollout_threads', 1)
